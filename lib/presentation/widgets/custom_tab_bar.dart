...
class ShiftingTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  ///
  /// The [bgColor] argument is used as background of tab bar If a [bgColor] is not provided
  ...
  /// [bgColor] argument or [ThemeData.primaryColor] as arguments to determines this property.
  ...
  ///
  /// If a [bgColor] is not provided then it will use ancestor [ThemeData.primaryColor]
  ...
  ///
  /// The flex value for [Widget] widgets and also the default value of this property is 1.0
...
class _ShiftingTabBarState extends State<ShiftingTabBar> {
  ...
  void didChangeDependencies() {
    ...
    _color = widget.bgColor ?? Theme.of(context).primaryColor;
