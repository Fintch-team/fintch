...
class DataUser {
    ...
    factory DataUser.fromJson(Map<String, dynamic> json) => DataUser(
        ...
        receive: List<School>.from(json["receive"].map((x) => School.fromJson(x))),
        moneyPlanning: List<MoneyPlanning>.from(json["money_planning"].map((x) => MoneyPlanning.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "money_planning": List<dynamic>.from(moneyPlanning.map((x) => x.toJson())),
    };
}
